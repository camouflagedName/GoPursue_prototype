...
export class ShuffleButton extends React.Component {
   ...
   /* changeCareer() {
        ...
        const userURL = `${API_ROOT}/api/v1/users/show/${this.props.current.userID}`;
        ...
        .then(response => {
            this.setState({ response: response, previous: this.props.current })
        });
    ...
    render() {
        return (
            <button onClick={this.props.change} className="btn btn-primary btn-lg me-1">
