...
//TODO: turn this into data object
const user = localStorage.getItem('userID') ? localStorage.getItem('userID') : null
const initialUserName = localStorage.getItem('user') ? localStorage.getItem('user') : "not logged in"
...
export default function Profile(props) {
    ...
    const [time, setTime] = useState(appStartTime)

    const logout = () => {
        localStorage.clear();
        return <TotalTime time={time} user={userID} />
    }
    return (
        <>
            <div className="mt-auto mb-5 col-6 offset-3 justify-content-center text-center">
                ...
                <h1 className="text-center" style={{ color: props.style.textColor }}>{userName}</h1>
            </div>
