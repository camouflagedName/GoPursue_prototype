    ...
    render() {
        return (
            <>
                ...
                {
                    this.state.title === 'bookmark'
                        ? <Bookmarks screen={this.props.screen} userData={this.props.userData} style={this.props.style} />
                        : <Search search={this.state.careerMatch} term={this.state.searchTerm} screen={this.props.screen} userData={this.props.userData} style={this.props.style} />
                }
            </>
        );
    }
