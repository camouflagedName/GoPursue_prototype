...
import Name from './NewUser/Name'
import Age from './NewUser/Age';
import Password from './NewUser/Password';
import User from '../../UserData';
import Email from './NewUser/Email';
import ResponseWait from './NewUser/ResponseWait';
...
export default class NewUser extends React.Component {
    ...
    changePage(currentPage) {
        switch (currentPage) {
            case 'email':
                return (<Email header={this.changePage} input={this.inputChange} value={this.state.input} verify={this.verifyEmail} error={this.state.emailError} setPage={this.props.setPage} />);
