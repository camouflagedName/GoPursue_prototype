        ...
        return (
            <div className="d-flex flex-column bg-light col-2 g-0 mt-1">
                <a href="" className="d-flex align-items-center justify-content-center text-decoration-none link-dark">
                    <img className='col-8' src={require(`../../../assets/logo/logo(cropped).jpg`)} alt="logo" />
                </a>
                <hr />
                ...
                <div className="justify-content-end">
                    <ul className="nav nav-pills flex-column mb-auto d-none d-md-block">
                        ...
                        <li className="nav-item">
                            <Link to="/admin/dashboard" className="nav-link link-dark text-decoration-none">TBD</Link>
                        </li>
                    </ul>
                </div>
                <div className="justify-content-end">
                    <ul className="nav nav-pills nav-flush flex-column mb-auto me-auto mb-lg-0 d-block d-md-none">
                        ...
                        <li className="nav-item">
                            <Link to="/admin/dashboard" className="nav-link link-dark py-3 border-bottom" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Dashboard">
