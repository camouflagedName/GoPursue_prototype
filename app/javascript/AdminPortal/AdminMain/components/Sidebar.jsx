...
export function Sidebar(props) {
    ...
    return (
        <div className="d-flex flex-column bg-light col-2 g-0 mt-1">
            ...
            <div className="justify-content-end">
                <ul className="nav nav-pills nav-flush flex-column mb-auto me-auto mb-lg-0 d-block d-md-none" onClick={handleSelectSmall}>
                    <li className="nav-item">
                        <a className="nav-link active py-3 border-bottom" aria-current="page" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Dashboard">
                            <svg id="Home" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-house" viewBox="0 0 16 16">
                    ...
                    <li className="nav-item">
                        <a className="nav-link link-dark py-3 border-bottom" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Dashboard">
                            <svg id="Users" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-people-fill" viewBox="0 0 16 16">
                    ...
                    <li className="nav-item">
                        ...
                        <div className="collapse" id="content">
                            <a id="Show All" className="text-muted text-decoration-none">Show All</a>
                        </div>
                        <div className="collapse" id="content">
                            <a id="Add New" className="text-muted text-decoration-none">Add New</a>
                        </div>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link link-dark py-3 border-bottom" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Dashboard">
